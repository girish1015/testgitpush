...
# Record = Collection.find({'item' : 'sketch pad', 'qty' : {"$gte" : 75}}) # AND Condition
Record = Collection.find({'$or' : [ {'item' : 'sketch pad', 'qty' : {"$gte" : 75}}]}) # OR Condition
for i in Record:
    print(i)